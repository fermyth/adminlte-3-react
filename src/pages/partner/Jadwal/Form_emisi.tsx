...
const FormUjiEmisi: React.FC<FormUjiEmisiProps> = ({ initialSkorEmisi = "", initialStatusUji = "success" }) => {
  ...
  return (
    <div className="form-container">
      ...
      <div className="form-card">
        <h1 className="text-center mb-4 text-dark font-weight-bold">Update Uji Emisi</h1>
            ...
            <Card.Body>
              <Form.Group controlId="formSkorEmisi" className="mb-3">
                ...
                <Form.Control
                  ...
                  value={skorEmisi}
                  onChange={(e) => setSkorEmisi(e.target.value)}
                  required
                />
              </Form.Group>
