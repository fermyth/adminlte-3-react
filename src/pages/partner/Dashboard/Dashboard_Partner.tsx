...
const DashboardPartner = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(`http://localhost:5182/api/v1/jadwals-stnk-renewal/${idCompany}`);
        const data = await response.json();
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(`http://localhost:5182/api/v1/jadwals-emission-test/${idCompany}`);
        const data = await response.json();
        console.log("asasas", data);
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(`http://localhost:5182/api/v1/jadwals-service_rutin/${idCompany}`);
        const data = await response.json();
        console.log("asasas", data);
